...
class CreateImportDir extends MasterRepo implements FateLogger {
  ...
  public Repo<Master> call(long tid, Master master) throws Exception {
    ...
    FateInfo(tid, String.format("Looking for matching filesystem for %s from options %s",
        exportDir, Arrays.toString(tableDirs)));
    ...
    FateInfo(tid, String.format("Chose base table directory: %s", base));
    ...
    FateInfo(tid, String.format("Using import directory: %s", tableInfo.importDir));
